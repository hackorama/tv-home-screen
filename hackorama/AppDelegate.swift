...
class AppDelegate: UIResponder, UIApplicationDelegate, TVApplicationControllerDelegate {
  ...
  // TODO FIXE Read base url from config file, env variable
  ...
  func application(
    ...
    appController = TVApplicationController(
      context: appControllerContext, window: window, delegate: self)
  ...
  func appController(
    _ appController: TVApplicationController, didFinishLaunching options: [String: Any]?
  ) {
  ...
  func appController(_ appController: TVApplicationController, didFail error: Error) {
    ...
    self.appController?.navigationController.present(
